...
class KeyService
{
    public function create(string $name): array
    {
        ...
        $key->saveOrFail();
        $nonce = sodium_bin2base64(random_bytes(SODIUM_CRYPTO_GENERICHASH_BYTES_MAX), SODIUM_BASE64_VARIANT_URLSAFE_NO_PADDING);
        ...
        $apiKey .= '.'.$signature;
        $key->key = sodium_bin2base64(sodium_crypto_generichash($apiKey, '', SODIUM_CRYPTO_GENERICHASH_BYTES_MAX), SODIUM_BASE64_VARIANT_ORIGINAL_NO_PADDING);
        $key->saveOrFail();
    ...
    public function verify(string $key): bool
    {
        ...
        return 0 === sodium_compare($keyDb->key, sodium_bin2base64(sodium_crypto_generichash($key, '', SODIUM_CRYPTO_GENERICHASH_BYTES_MAX), SODIUM_BASE64_VARIANT_ORIGINAL_NO_PADDING));
    }
